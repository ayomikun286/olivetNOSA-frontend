...
export default function InLovingMemory() {
        ...
        const fetchMemorials = async () => {
            try {
                ...
                const response = await fetch(
                    `${import.meta.env.VITE_API_URL}/api/memorials${query ? `?${query}` : ""
                    }`
                );
                ...
                if (!response.ok || !result.success) {
                    throw new Error(
                        result.message || "Unable to load memorial records."
                    );
                }
    ...
    const hasFilters = search || schoolSet || graduationYear;
                    ...
                    {!loading && !error && memorials.length === 0 && (
                        <div className="border border-black/10 bg-white px-6 py-20 text-center">
                            ...
                            <p className="mx-auto mt-3 max-w-md text-sm leading-7 text-[var(--text-muted)]">
                                We could not find a memorial matching your search or selected
                                filters.
                            </p>
                        ...
                        "
                                    ...
                                    <div className="p-7">
                                        ...
                                        <button
                                            ...
                                            className="group inline-flex items-center gap-2 text-sm font-semibold text-[var(--primary)] transition hover:text-[var(--primary-dark)]"
                                        >
                                            View Memorial
